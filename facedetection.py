import cv2 from tensorflow.keras.models 
import load_model from keras.preprocessing.image 
...
while True:
 ...
 for(x,y,w,h) in faces:
    ...
    img = load_img('input%d%dface.jpg'%(img_count_full,img_count),target_size=(img_widt
